...
- **Benchmark 2026-07-30 (dev, n=500, grow-sample E1 cap):** SHA `6b9abc8a3ad40ee0895444842d6bed60f93f4b13`, seed workflow-default, n=500, dev, baseline=superforcaster-polymarket-v2, platform=polymarket -- posted (comment #5128542509). **Cancelled** -- new memory-only commit (`783a3a7f`) was pushed to the branch, invalidating the workflow run.
- **Benchmark 2026-07-30 (dev, n=500, re-trigger after chore commit):** SHA `783a3a7f0b51a92260fe6c0a8866b31d40290bfb`, seed workflow-default, n=500, dev, baseline=superforcaster-polymarket-v2, platform=polymarket -- posted (comment #5128801622). Tool code unchanged from `b506836f`; chore commit `783a3a7f` only fixed comment ID in this memory file. **Cancelled** -- new chore commit (`a5cdc323`) was pushed to record prior results, invalidating the workflow run.
- **Benchmark 2026-07-30 (dev, n=500, stable-SHA re-trigger):** SHA `a5cdc3230184153b35d4667b97357b2b2564ba61`, seed workflow-default, n=500, dev, baseline=superforcaster-polymarket-v2, platform=polymarket -- posted (comment #5129105480). All 24 CI checks green; no pending commits. Previous n=500 attempts at SHAs `6b9abc8a` and `783a3a7f` both cancelled by new commits; this is the first stable-SHA trigger at the E1-cap sample size. Tool code unchanged from `b506836f`.
