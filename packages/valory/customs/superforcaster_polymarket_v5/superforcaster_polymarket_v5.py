...
-----------------------------------------------------------------------
v5 adds a mandatory evidence-reliability screen at PREDICTION_PROMPT step 4
...
(4c) Temporal-evidence classification: TYPE A (within-window dated) vs TYPE B
     ...
     p_yes=0.99 on standing pages and resolved NO.
...
(4d) Criterion-specificity check: require TYPE A evidence that directly confirms
     ...
     word in a named outlet's headline), not mere topic salience.

Confirmed by issue #382 investigation (W-1 2026-06-25..2026-07-02, Brier
0.3679, n=559): 8/10 worst-miss deliveries showed good-evidence/bad-reasoning
at the prediction-LLM-call stage -- topically relevant search results
(including past-event evidence and market-odds pages) were incorrectly treated
as direct resolution-criterion confirmation.
"""
