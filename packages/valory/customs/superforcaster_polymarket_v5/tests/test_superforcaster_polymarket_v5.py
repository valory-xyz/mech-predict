...
class TestStructuredOutputContract:
    ...
    def test_on_chain_result_is_flat_json_loads_parseable(
        ...
        assert "base_rate_required" not in parsed
...
class TestPredictionResultSchema:
    ...
    def test_base_rate_required_field_present(self) -> None:
        """v5 schema has base_rate_required bool between the screen and aggregation."""
    ...
    def test_base_rate_required_is_bool(self) -> None:
        ...
        field = PredictionResult.model_fields["base_rate_required"]
