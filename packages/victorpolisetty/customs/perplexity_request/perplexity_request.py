...
#     api_key = "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"  # Replace with your actual Perplexity API key
#     tool = "llama-3.1-sonar-small-128k-online"  # Choose a model from ALLOWED_TOOLS
#     prompt = "How many stars are there in the Milky Way galaxy?"

#     # Define additional parameters if needed
#     kwargs = {
#         "api_keys": {"perplexity": api_key},
#         "tool": tool,
#         "prompt": prompt,
...
#     # Call the run function and handle the response
#     result, used_prompt, _, _ = run(**kwargs)
