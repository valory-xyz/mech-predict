...
if [[ "$NETWORK"=="base" ]]; then
    ...
    export SKILL_TASK_EXECUTION_MODELS_PARAMS_ARGS_MECH_MARKETPLACE_ADDRESS="0xf24eE42edA0fc9b33B7D41B06Ee8ccD2Ef7C5020"
    export SKILL_MECH_ABCI_MODELS_PARAMS_ARGS_HASH_CHECKPOINT_ADDRESS="0x2247aD1aEFFA724f01aF17Fa43b4D1a1d256b45e"
